...
from nexpy import ObservableList, ObservableSelectionDict, ObservableSet
from nexpy import ObservableSelectionSet as ObservableSelectionOption, ObservableOptionalSelectionSet as ObservableOptionalSelectionOption, ObservableMultiSelectionSet as ObservableMultiSelectionOption
...
class TestEmitterHooksListeners:
    ...
    def test_secondary_hook_binding(self):
        ...
        length_hook = obs_list.length_hook
        length_hook.join(length_tracker.hook, "use_caller_value")  # type: ignore
